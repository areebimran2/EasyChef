                ...
                <ul className="nav">
                    ...
                    <li className="nav-item">
                        ...
                        <ul className="dropdown-menu position-absolute ">
                          ...
                          {loggedin ? <li onClick={() => {setLoggedIn(false); localStorage.removeItem('token')}}><Link to="/" className='dropdown-item'>Log out</Link></li> : <li><Link to="/profile" className='dropdown-item'>Log in</Link></li>}
                        </ul>
                    </li>
                </ul>                
            </div>
